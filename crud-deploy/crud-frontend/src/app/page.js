...
export default function Home() {
  ...
  return (
    <div className="container mx-auto p-4">
      <div className='flex justify-between px-24 py-6'>  <h1 className="text-3xl font-bold mb-6 text-center">Product Management</h1>
      <button onClick={() => setShowForm(true)} className="mb-4 bg-blue-500 text-white px-4 py-2 rounded hover:bg-blue-600">Add Product</button></div>
